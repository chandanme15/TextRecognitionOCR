...
import com.example.textrecognition.activities.OcrCaptureActivity;
...
public class CameraSource {
    ...
    public static Boolean terminateDetection = false;
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    if(terminateDetection){
                        terminateDetection = false;
                        ((Activity)(OcrCaptureActivity.context)).finish();
                        break;
                    }
                } catch (Throwable t) {
